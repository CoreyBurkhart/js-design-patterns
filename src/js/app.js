...
Todo.prototype.createElement = function() {
...
Todo.prototype.complete = function(e) {
  if(e.target.checked) {
...
Todo.prototype.toggleVisibility = function(e) {
...
Todo.prototype.editElementContent = function(type, text) {
  let ch = this.element.children;
  switch(type) {
    case 'input':
    ch[0].value = text;
...
Todo.prototype.setDefaultText = function(text) {
  if(text !== '') {
...
Todo.prototype.init = function() {
  this.createElement();
  this.setDefaultText(this.todoText);
}
